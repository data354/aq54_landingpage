...
function getRightIconColor(pm2_5: number) {
  if (pm2_5 <= 12) return "green"
  else if (12 < pm2_5 && pm2_5 < 36) return "gold"
  else if (36 < pm2_5 && pm2_5 < 56) return "orange"
  else if (56 < pm2_5 && pm2_5 < 151) return "red"
  else if (151 < pm2_5 && pm2_5 < 251) return "violet"
  else if (251 < pm2_5 && pm2_5 < 501) return "black"
}

export function getIcon(pm2_5: number) {
  return icon({
    iconSize: [25, 41],
    iconAnchor: [12, 41],
    popupAnchor: [1, -34],
