      ...
      <div className="container px-5 mx-auto">
        <div className="max-w-4xl mx-auto">
          ...
          <ul className="list-inside list-disc space-y-5 my-10 text-justify leading-loose">
            <li>La <b>matière particulaire</b> (ou particulate matter, PM en anglais) est composée de particules de petite taille, inférieures à 10 µm pour les <b>PM10</b> (particules respirables), à 2.5 µm pour les <b>PM2.5</b> (particules fines), ou encore à 1 µm pour les <b>PM1</b> (particules ultrafines).
            ...
            <li>Le <b>monoxyde de carbone (CO)</b> est un gaz toxique, incolore, inodore, insipide, qui est un résidu de combustions incomplètes, et provient le plus souvent des véhicules motorisés. En intérieur, l’exposition à de hautes concentrations peut provoquer des intoxications et même être mortelles.</li>
            ...
            <li>Le <b>dioxyde de soufre (SO2)</b> est un gaz incolore d’odeur désagréable, dégagé par la combustion de pétrole ou charbon par exemple. L’exposition excessive peut mener à des crises d’asthme aigües.</li>
            <li>Parmi <b>d’autres polluants</b>, on peut citer le plomb (Pb), des hydrocarbures, le formaldéhyde…</li>
          </ul>
          <p className="">
          ...
          <p className="mb-6">
            ...
            populations qui y sont exposées, à la fois sur le <b>court terme et le long terme</b>. Selon l’OMS, <b>99%</b> de la population mondiale respire un air
            trop pollué et dangereux : les effets cumulés de pollution de l’air ambiant et de pollution de l’air à l’intérieur des habitations sont liés à <b>7 millions de morts prématurées par an</b> (soit environ une sur huit). En Côte d’Ivoire, on estime ce nombre à 23 100. La pollution de l’air
