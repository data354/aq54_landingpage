      ...
      <div className="container px-5 mx-auto">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-400 leading-10 mb-6">
            <a className="text-blue-500 hover:text-blue-600" href="https://www.ccacoalition.org/en/content/short-lived-climate-pollutants-slcps" target="_blank" rel="noopener noreferrer">www.ccacoalition.org</a><br />
            <a className="text-blue-500 hover:text-blue-600" href="https://www.epa.gov/ghgemissions/understanding-global-warming-potentials" target="_blank" rel="noopener noreferrer">www.epa.gov</a><br />
          ...
          <p className="mb-6">
            ...
            dioxyde de carbone (CO2), mais ont un <b>potentiel de réchauffement global (PRG)</b> important. Ce potentiel désigne le
